                ...
                if (fullname_1 === "Microsoft.FSharp.Core.FSharpOption`1[System.Object]") {
                    ...
                    if ((fullName(keyType) === "System.String") ? true : (fullName(keyType) === "System.Guid")) {
                        return (value_12) => fold((target, _arg1) => {
                            const activePatternResult8137 = _arg1;
                            target[activePatternResult8137[0]]=valueEncoder(activePatternResult8137[1]);
                            return target;
                        }, {}, value_12);
                    }
                    else {
                        ...
                        return (value_13) => seq(map_2((_arg2) => {
                            const activePatternResult8141 = _arg2;
                            return [keyEncoder(activePatternResult8141[0]), valueEncoder(activePatternResult8141[1])];
                        }, value_13));
                    }
                }
                else {
